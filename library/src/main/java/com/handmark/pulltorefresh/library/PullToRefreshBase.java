...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
        LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(null,context, mode,
                getPullToRefreshScrollDirection(), attrs);
        layout.setVisibility(View.INVISIBLE);
        return layout;
    }

    protected LoadingLayout createCustomeLoadingLayout(LoadingLayout layout, Context context, Mode mode, TypedArray attrs) {
        LoadingLayout layoutDefault = mLoadingAnimationStyle.createLoadingLayout(layout,context, mode,
                getPullToRefreshScrollDirection(), attrs);
    ...
    protected final void refreshLoadingViewsSize() {
        ...
        switch (getPullToRefreshScrollDirection()) {
            ...
            case VERTICAL:
                Log.d("wang","maximumPullScroll " + maximumPullScroll);
                if (mMode.showHeaderLoadingLayout()) {
    ...
    public void setCustomAnimateLayout(Context context, LoadingLayout layout) {
    ...
    public static enum AnimationStyle {
        ...
        LoadingLayout createLoadingLayout(LoadingLayout layout, Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            if (layout != null) {
                return layout;
            } else {
                switch (this) {
